...
from .models import Category, Product, FavoriteComparison
from .serializers import CategorySerializer, ProductSerializer, CompareRequestSerializer, CompareResultSerializer, FavoriteComparisonSerializer
